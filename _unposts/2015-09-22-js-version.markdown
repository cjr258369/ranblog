...
![java-javascript]({{ site.urlLocation }}/img/in-post/post-js-version/javascript-java.jpg)
...
<img class="shadow" width="320" src="{{ site.urlLocation }}/img/in-post/post-js-version/keep-calm-and-learn-javascript.png" />
